...
HD_PWD='C:/Users/abc78/SoC_course/SoC_project_3/SoC_project_3.runs/SoC_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SoC_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SoC_processing_system7_0_1.tcl
